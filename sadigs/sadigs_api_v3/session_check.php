...
if (isset($_GET['reset_permissions']) && $_GET['reset_permissions'] == '1') {
    try {
        ...
        $defaults = [
            ...
            'Ustadz' => ['navDashboard', 'navProfil', 'navKalender', 'navAbsensi', 'navIzinPegawai', 'navJadwalRapat', 'navRppGenerator', 'navRppAlbum', 'navPerencanaanAkademik', 'navInputNilai'],
            'Ustadzah' => ['navDashboard', 'navProfil', 'navKalender', 'navAbsensi', 'navIzinPegawai', 'navJadwalRapat', 'navRppGenerator', 'navRppAlbum', 'navPerencanaanAkademik', 'navInputNilai'],
