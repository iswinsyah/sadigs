...
$master_structure = [
    ...
    'Kepegawaian' => [
        ...
        'items' => [
            ...
            ['id' => 'navRekapAbsensi', 'label' => 'Rekap Absensi', 'icon' => 'clipboard-list', 'link' => 'attendance_recap.html'],
